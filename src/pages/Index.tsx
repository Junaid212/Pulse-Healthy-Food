...
const [src, setSrc] = useState(
    'https://ismail-is.github.io/pulse-webiste/assets/images/allimg/dishpng/rotate/3.png',
  );
...
<section className="py-20 relative overflow-hidden   bg-gradient-to-br from-green-800 via-green-600 to-green-500 mt-[-40px]" >
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    {/* Image Grid */}
 <div className="grid grid-cols-10 grid-rows-9 gap-1 xs:gap-2 sm:gap-3 md:gap-4">
    {/* Row 1-3 */}
    ...
    <div className="col-span-2 row-span-2 col-start-5">
        <img src="/img/all img/pb-1.jpg" alt="Feature 2"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div className="col-span-2 row-span-2 col-start-7">
        <img src="/img/all img/pb-2.jpg" alt="Feature 3"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div className="col-span-2 row-span-3 col-start-9">
        <img src="/img/all img/pb-3.jpg" alt="Feature 4"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>

    {/* Row 3-6 */}
    <div className="col-span-4 row-span-3 col-start-5 row-start-3">
        <img src="/img/all img/pu-2.jpg" alt="Feature 5"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    ...
    <div className="col-span-2 row-span-2 col-start-3 row-start-4">
        <img src="/img/all img/pu-3.jpg" alt="Feature 7"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>

    {/* Bottom & Side Images */}
    <div className="col-span-2 row-span-3 col-start-1 row-start-6">
        <img src="/img/all img/pu-1.jpg" alt="Portrait 1"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div className="col-span-2 row-span-3 col-start-7 row-start-6">
        <img src="/img/all img/pu5.jpg" alt="Portrait 2"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div className="col-span-2 row-span-2 col-start-9 row-start-7">
        <img src="/img/all img/pb-4.jpg" alt="Portrait 3"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div className="col-span-2 row-span-3 col-start-9 row-start-4">
        <img src="/img/all img/pu4.jpg" alt="Portrait 4"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div className="col-span-4 row-span-3 col-start-3 row-start-6">
        <img src="/img/all img/pu-6.jpg" alt="Portrait 5"
            className="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
</div>
  ...
  <div className="container mx-auto max-w-7xl relative z-10">
    <div className="grid md:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mt-8 sm:mt-12 px-4 sm:px-0">
  {[
    ...
    <div
      key={label}
      className="rounded-lg md:rounded-xl bg-white px-3 py-4 sm:px-4 sm:py-5 shadow-md hover:shadow-xl flex flex-col items-center border hover:-translate-y-1 transition-all duration-300"
      style={{
        borderColor: '#159545',
        borderWidth: '1.5px'
      }}
    >
      ...
      <span className="text-xs sm:text-sm md:text-base text-black font-medium mt-1 sm:mt-2 text-center">
        {label}
      </span>
    </div>
  ))}
 ...
 {/* <MenuSection/> */}
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <div className="mt-16 text-center">
      ...
      {/* CTA Section */}
<section className="relative py-28 bg-green-700 overflow-hidden rounded-t-[40px] md:rounded-t-[80px]">
  ...
  <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    {/* Buttons */}
    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center animate-fade-in-up delay-200">
  <Link to="/menu" className="w-full sm:w-auto">
    <Button
      size="lg"
      className="w-full sm:w-auto bg-white text-green-700 hover:bg-green-100 hover:shadow-xl px-4 sm:px-6 md:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold flex items-center justify-center transition-all duration-300"
    >
  ...
  <Link to="/subscription" className="w-full sm:w-auto">
    <Button
      size="lg"
      variant="outline"
      className="w-full sm:w-auto border-2 border-white bg-transparent text-white hover:bg-white hover:text-green-700 hover:shadow-xl px-4 sm:px-6 md:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold transition-all duration-300"
    >
      View Meal Plans
    </Button>
  </Link>
